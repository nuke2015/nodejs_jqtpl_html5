...
(function ($) {      
    $.fn.date = function (options,Ycallback,Ncallback) {   
        ...
        var initY=parseInt((nowdate.getFullYear()))-2015;
        ...
        function CreateDateUI(){
            var str = ''+
                ...
                '<div id="datePage" class="page">'+
                    '<section>'+
                        '<div id="datetitle"><p style="font-size:16px;">请选择服务日期</p></div>'+
                    ...
                    '<footer id="dateFooter">'+
                        '<div id="setcancle">'+
                            '<ul>'+
                                '<li id="dateconfirm" class="queding">确定</li>'+
                                '<li id="datecancle" class="quxiao">取消</li>'+
                            '</ul>'+
                        '</div>'+
                    '</footer>'+
                '</div>'
